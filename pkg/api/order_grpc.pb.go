...
const (
	...
	OrderService_AcceptOrder_FullMethodName        = "/api.OrderService/AcceptOrder"
	OrderService_RejectOrder_FullMethodName        = "/api.OrderService/RejectOrder"
)
...
type OrderServiceClient interface {
	...
	AcceptOrder(ctx context.Context, in *DriverOrderActionRequest, opts ...grpc.CallOption) (*Order, error)
	RejectOrder(ctx context.Context, in *DriverOrderActionRequest, opts ...grpc.CallOption) (*Order, error)
}
...
func (c *orderServiceClient) AcceptOrder(ctx context.Context, in *DriverOrderActionRequest, opts ...grpc.CallOption) (*Order, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Order)
...
func (c *orderServiceClient) RejectOrder(ctx context.Context, in *DriverOrderActionRequest, opts ...grpc.CallOption) (*Order, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Order)
...
type OrderServiceServer interface {
	...
	// Driver response to an assignment offer
	AcceptOrder(context.Context, *DriverOrderActionRequest) (*Order, error)
	RejectOrder(context.Context, *DriverOrderActionRequest) (*Order, error)
...
func (UnimplementedOrderServiceServer) AcceptOrder(context.Context, *DriverOrderActionRequest) (*Order, error) {
	return nil, status.Error(codes.Unimplemented, "method AcceptOrder not implemented")
}
func (UnimplementedOrderServiceServer) RejectOrder(context.Context, *DriverOrderActionRequest) (*Order, error) {
...
func _OrderService_AcceptOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DriverOrderActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).AcceptOrder(ctx, req.(*DriverOrderActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_RejectOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).RejectOrder(ctx, req.(*DriverOrderActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
